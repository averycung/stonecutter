  ...
  return (
    <div className="absolute left-2 -top-16 ">
      <div className="border-4 border-stone-700  bg-white 
        dark:bg-stone-800 dark:border-4 dark:border-stone-600 shadow-2xl p-4 max-w-96 mx-5 transition-all ease-linear duration-500">
          <div className='border dark:border-stone-600'>
            <span className="block text-left text-sm font-dmserif p-2 text-black dark:text-stone-300">
            ...
            <span className="block font-dmserif text-black dark:text-stone-300 pb-2 text-xs pr-2 text-right">Jacob Riis</span>
          </div>
        </div>
      </div>
  )
